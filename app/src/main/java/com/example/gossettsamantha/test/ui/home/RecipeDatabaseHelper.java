...
public class RecipeDatabaseHelper extends SQLiteOpenHelper {
    ...
    private void updateMyDatabase(SQLiteDatabase db, int oldVersion, int newVersion) {
        if (oldVersion < 1) {
            ...
            insertIngredientRecipeTable(db, 1, 19,21);            insertIngredientRecipeTable(db, 1, 16,32);
            ...
            insertIngredient(db, 0, "vegetable oil");
            insertIngredient(db, 1, "diced onion");
            insertIngredient(db, 2,  "minced garlic");
            insertIngredient(db, 3,  "chopped green chilies");
            insertIngredient(db, 4,  "Mexican-style hot tomato sauce");
            insertIngredient(db, 5,  "rotisserie chicken");
            insertIngredient(db, 6,  "Neufchatel cheese");
            insertIngredient(db, 7,  "Mexican cheese blend");
            insertIngredient(db, 8,  "salt");
            insertIngredient(db, 9,  "pepper");
            insertIngredient(db, 10,  "corn tortillas");
            insertIngredient(db, 11,  "avocado oil cooking spray");
            insertIngredient(db, 12,  "cooking spray");
            insertIngredient(db, 13,  "butter");
            insertIngredient(db, 14,  "large onion");
            insertIngredient(db, 15,  "white sugar");
            insertIngredient(db, 16,  "medium apples");
            insertIngredient(db, 17,  "Yukon Gold potatoes");
            insertIngredient(db, 18,  "olive oil");
            insertIngredient(db, 19,  "bone-in chicken thighs with skin");
            insertIngredient(db, 20,  "chopped rosemary");
            insertIngredient(db, 21,  "baby spinach leaves");
            insertIngredient(db, 22,  "arugula");
            insertIngredient(db, 23,  "garlic");
            ...
            insertInstruction(db, 3, 1, "1. Preheat the oven to 400 degrees F (200 degrees C). Spray the top and bottom parts of a broiler pan with cooking spray.");
            insertInstruction(db, 4, 1, "2. Melt butter in a skillet over medium heat and add onion slices. Sprinkle onions with 1 teaspoon salt and saute for 2 minutes. Add sugar and continue cooking until onions are translucent but not browned, 6 to 8 minutes. Remove from heat");
            insertInstruction(db, 5, 1, "3. Layer apples, potatoes, and sauteed onion slices in the bottom part of the broiler pan. Cover with the part top of the broiler pan");
            insertInstruction(db, 6, 1, "4. Drizzle olive oil over chicken thighs. Sprinkle with fresh rosemary, salt, and pepper. Rub olive oil and spices thoroughly all over each thigh and place on the top part of the broiler pan.");
            insertInstruction(db, 7, 1, "5. Roast in the preheated oven until juices run clear and an instant-read thermometer inserted into the thickest part of the thigh, near the bone, reads 165 degrees F (74 degrees C), about 1 hour. Serve apples, potatoes, and onion alongside chicken thighs.");

            insertInstruction(db, 8, 2, "1. Stuff spinach leaves, arugula, and garlic under the skin of the chicken thigh and place on a baking dish. Sprinkle with seasoned salt.");
            insertInstruction(db, 9, 2, "2. Bake chicken thigh in the oven set at 350 degrees F (175 degrees C) until no longer pink at the bone and the juices run clear, about 50 minutes. An instant-read thermometer inserted near the bone should read 165 degrees F (74 degrees C)");

            insertInstruction(db, 10, 3, "1. ");
